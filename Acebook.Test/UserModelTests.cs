...
namespace Acebook.Tests
{
    public class UserModelTestsPlaywright : PageTest
    {
        ...
        [Test]
        public async Task FormattedCreatedOnReturnsSuffixSt()
        {
        ...
        [Test]
        public async Task FormattedCreatedOnReturnsSuffixNd()
        {
        ...
        [Test]
        public async Task FormattedCreatedOnReturnsSuffixRd()
        {
        ...
        [Test]
        public async Task FormattedCreatedOnReturnsSuffixTh()
        {
